...
class RoverState():
    def __init__(self):
        ...
        self.nav_mean_dir = None # An angle thru freespace
        self.nav_rock_angles = None # Angles of navigable terrain pixels
        self.nav_rock_dists = None # Distances of navigable terrain pixels
        self.nav_mean_rock_dir = None # Direction to neerest rock
